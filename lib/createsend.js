...
function CreateSend (auth, options) {
    ...
    var result = {
        ...
        getCountries: function (callback) {
            return this.get('countries.json', null, null, callback);
        },

        getTimezones: function (callback) {
            return this.get('timezones.json', null, null, callback);
        },

        getSystemDate: function (callback) {
            return this.get('systemdate.json', null, null, function (err, result) {
        ...
        request: function (method, path, qs, params, callback, txBool) {
            let uri = ((this.secure) ? 'https' : 'http') + '://' + this.baseUri + '/api/' + (txBool ? 'v3.1' : this.version) + '/' + path;
            let request = Utils.request(this.secure, this.auth, method, uri, qs, params);
        ...
        post:   function (path, qs, params, callback, txBool) { return this.request('POST',   path, qs, params, callback, txBool); },
        get:    function (path, qs, params, callback, txBool) { return this.request('GET' ,   path, qs, params, callback, txBool); },
        put:    function (path, qs, params, callback, txBool) { return this.request('PUT' ,   path, qs, params, callback, txBool); },
        delete: function (path, qs, params, callback, txBool) { return this.request('DELETE', path, qs, params, callback, txBool); }
    };
